...
Load the data
```{r, echo=TRUE}
train <- read.csv("C:/Users/USER/Documents/GitHub/PracticalMachineLearning/pml-training.csv", na.strings=c("#DIV/0!"), row.names = 1)
test  <- read.csv("C:/Users/USER/Documents/GitHub/PracticalMachineLearning/pml-testing.csv", na.strings=c("#DIV/0!"), row.names = 1)
```
